...
## 🎯 核心目标
本工作区的最终目标不是单纯得到 `best.pt`，而是为后续 Chipyard `generators/gemmini/software/gemmini-rocc-tests/bareMetalC/shen_yolov11n.c` 提供完整输入。
...
- 详细字段格式统一参考模板文件：`shen_quant_params_template.json`、`shen_model_summary_template.md`、`shen_preprocess_postprocess_template.md`

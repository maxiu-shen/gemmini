...
// preload
//BD = rs1[31:0], BD_cols = rs1[47:32], BD_rows = rs1[63:48], C = rs2[31:0], C_cols = rs2[47:32], C_rows = rs2[63:48]
...
//id = rs1[4:3],block_mvin_stride = rs1[31:16],shrunk = rs1[2],scale = rs1[63:32],stride = rs2
